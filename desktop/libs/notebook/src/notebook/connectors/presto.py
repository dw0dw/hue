...
class Assist():
  ...
  def get_databases(self):
    dbs, description = query_and_fetch(self.db, 'SELECT SCHEMA_NAME FROM system.INFORMATION_SCHEMA.SCHEMATA')
  ...
  def get_tables_full(self, database, table_names=[]):
    tables, description = query_and_fetch(self.db, "SELECT TABLE_NAME,'COMMENT' COMMENT FROM system.INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='%s'" % database)
  ...
  def get_columns_full(self, database, table):
    columns, description = query_and_fetch(self.db, "SELECT COLUMN_NAME, DATA_TYPE, COMMENT FROM system.INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA='%s'  AND TABLE_NAME='%s'" % (database, table))
